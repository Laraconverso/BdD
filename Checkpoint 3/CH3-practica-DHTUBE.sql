...
--
-- Database: `PracticaCheckpoint3`
--
CREATE DATABASE IF NOT EXISTS `PracticaCheckpoint3` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `PracticaCheckpoint3`;
